...
jQuery.validator.addMethod(
  ...
  function(a, b) {
    ...
    if (/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(a)) {
      ...
      c =
        e.getFullYear() == d && e.getMonth() == f - 1 && e.getDate() == c
          ? true
          : false;
    } else c = false;
...
jQuery.validator.addMethod(
  ...
  function(a, b) {
    ...
    return (
      this.optional(b) ||
      (a.length > 9 &&
        a.match(/^(1-?)?(\([2-9]\d{2}\)|[2-9]\d{2})-?[2-9]\d{2}-?\d{4}$/))
    );
  },
...
jQuery.validator.addMethod(
  ...
  function(a, b) {
    return (
      this.optional(b) ||
      (a.length > 9 &&
        a.match(/^(\(?(0|\+44)[1-9]{1}\d{1,4}?\)?\s?\d{3,4}\s?\d{3,4})$/))
    );
  },
  "Please specify a valid phone number"
);
jQuery.validator.addMethod(
  ...
  function(a, b) {
    return (
      this.optional(b) ||
      (a.length > 9 && a.match(/^((0|\+44)7(5|6|7|8|9){1}\d{2}\s?\d{6})$/))
    );
  },
